...
namespace PanelPictureBoxSet
{
    public partial class PictureBoxEx : UserControl
    {
        ...
        public void setPictureBox(string imageFilePath)
        {
            Bitmap bitmap = new Bitmap(imageFilePath);
            setPictureBox(pictureBox_View, bitmap);
        }

        public void setPictureBox(Bitmap bitmap)
        {
            setPictureBox(pictureBox_View, bitmap);
        }

        private void setPictureBox(PictureBox p, string imageFilePath)
        {
            Bitmap bitmap = new Bitmap(imageFilePath);
            setPictureBox(p, bitmap);
        }

        private void setPictureBox(PictureBox p, Bitmap bitmap)
        {
        ...
        public Bitmap getImage()
        {
            ...
            return (Bitmap)(pictureBox_View.Image);
        }
